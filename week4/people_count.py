...
# Вие сте шеф на голяма концертна зала и искате да разберете колко хора са били общо на 
# концерта снощи.

# Тъй като системата за билети се е сринала, вие не знаете тази бройка.

# Оказва се, че имате обединените записи от всички входове, които отбелязват името на човек, 
# когато влезе и когато излезе.
...
# Функцията трябва да върне броят на отделните хора, 
# независимо колко пъти 1 човек е влизал или излизал.

# Тестови данни

# За да си вземете тестовеи данни, 
# може да заредите и изпълните файла в същата папка - test_data.py.
...
activity = ['Maria', 'Gergana', 'Ivo', 'Ivo', 'Ivo', 'Rado', 'Philip', 'Rado', 'Ivo', 
'Rado', 'Philip', 'Philip', 'Ivo', 'Anetta', 'Maria', 'Rado', 'Philip', 'Philip', 'Maria']
